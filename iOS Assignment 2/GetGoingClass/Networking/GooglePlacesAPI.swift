...
class GooglePlacesAPI {
    ...
    class func requestPlaces(_ query: String, radius: Int32, isOpen: Bool, completion: @escaping(_ status: Int, _ json: [String: Any]?) -> Void) {
        ...
        urlComponents.queryItems = [
            ...
            URLQueryItem(name: "isOpen", value: "\(isOpen)")
        ]
    ...
    class func requestPlacesNearby(for coordinate: CLLocationCoordinate2D, radius: Double, rankby: String, isOpen: Bool, _ query: String?, completion: @escaping(_ status: Int, _ json: [String: Any]?) -> Void) {
        var urlComponents = URLComponents()
        urlComponents.scheme = Constants.scheme
        urlComponents.host = Constants.host
